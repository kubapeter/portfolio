...
public class EncryptServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		returnString.append("</br></br><label for='dbcon'>Database Connection is &nbsp&nbsp</label>");

		ServletContext applicationScope = request.getServletContext();
		String dbcon = (String) applicationScope.getAttribute("dbConnection");

		returnString.append(dbcon + "</br></body></html>");
