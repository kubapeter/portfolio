-- 1. Use the order_binary metric from the previous exercise, 
...
-- 2. Create a new tem view binary metric. 
...
-- 3. Alter the result from exercise 2, to compute the users who viewed an item within 30 days of their treatment event
...
-- 4. Create the metric invoices (this is a mean metric, not a binary metric) and for test_id = 7
-- a) The count of users per treatment group
-- b) The average value of the metric per treatment group
-- c) The standard deviation of the metric per treatment group
