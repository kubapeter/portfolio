-- 1. Using the table from test_assignments.sql exercise 3 
-- compute a metric that measures whether a user created an order after their test assignment
...
-- 2. Using the table from the previous exercise, add the following metrics
-- a) the number of orders/invoices
-- b) the number of items/line-items ordered
-- c) the total revenue from the order after treatment
