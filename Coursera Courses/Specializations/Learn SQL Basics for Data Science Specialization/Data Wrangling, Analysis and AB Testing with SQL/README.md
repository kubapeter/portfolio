...
## Remarks
- tables do not exist, numbers do not match, pivot is not defined, not told, rename column without telling(cutscene) , windowing functions absolutely ununderstandable
